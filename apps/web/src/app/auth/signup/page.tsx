...
import { FileText, Mail, Lock, Github, CheckCircle2, AlertCircle } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.session) {
        // Email verification not required (confirmed email)
            ...
            <CardContent className="text-center py-8">
              ...
              <div className="rounded-lg bg-surface-50 p-4 text-left dark:bg-surface-800 mb-6">
                <p className="text-sm text-surface-600 dark:text-surface-400 mb-2">
                  <strong className="text-surface-900 dark:text-white">Next steps:</strong>
                </p>
              ...
              {error && (
                <div className="rounded-lg bg-red-50 p-3 text-sm text-red-600 dark:bg-red-900/20 dark:text-red-400 mb-4 flex items-center gap-2">
        ...
        <Card variant="bordered" padding="lg">
          <CardHeader className="text-center">
            ...
            <div className="flex justify-center gap-4 mt-4">
              ...
              <CurrencySelector usdAmount={0} variant="compact" />
            </div>
          </CardHeader>
